...
class LevelThreePageText:
    def __init__(self):
        ...
        self.introduction1_textLine1 = font.render("Hello, this is the messenger from the Pisces interstellar region.", True,
                                              (0, 0, 0))
        self.introduction1_textLine2 = font.render(
            "You are about to enter our territory, and according to our communication records,", True, (0, 0, 0))
        self.introduction1_textLine3 = font.render(
            "you do not have the permission to enter. However, since you have managed to", True, (0, 0, 0))
        self.introduction1_textLine4 = font.render("reach this point, I assume you are aware of the rules.", True,
                                              (0, 0, 0))
        self.introduction1_textLine5 = font.render("Would you like to take on the challenge?", True, (0, 0, 0))

        # 玩家选择答题后的提醒文字
        self.reminder1_textLine1 = font.render("You are indeed very brave. Let's begin then.", True, (0, 0, 0))
        self.reminder1_textLine2 = font.render("There are a total of 9 questions here. Good luck!", True,
                                                   (0, 0, 0))

        # 玩家答题失败后的提醒文字
        self.reminder2_textLine1 = font.render("I'm sorry, but you did not meet the requirements,", True,
                                                   (0, 0, 0))
        self.reminder2_textLine2 = font.render("so I cannot grant you access. Please feel free to come", True,
                                                   (0, 0, 0))
        self.reminder2_textLine3 = font.render("back and challenge again in the future.", True, (0, 0, 0))
        ...
        self.reminder3_textLine3 = font.render(
            "region. However, I must warn you that the monsters in our region", True, (0, 0, 0))
        self.reminder3_textLine4 = font.render("are quite formidable.", True,
                                                                   (0, 0, 0))
        self.reminder3_textLine5 = font.render(
            "I wish you good luck and smooth sailing on your journey.", True, (0, 0, 0))
        ...
        self.introduction2_textLine2 = font.render(
            "This was one of the first places to be invaded by the interstellar destroyers.", True, (0, 0, 0))
        self.introduction2_textLine3 = font.render(
        ...
        self.introduction2_textLine4 = font.render(
            "If you can help us defeat them, you will become a hero of our interstellar region.", True, (0, 0, 0))
        self.introduction2_textLine5 = font.render("Good luck to you!", True, (0, 0, 0))
        ...
        self.end_textLine2 = font.render("That's incredible! You have truly become a hero of the interstellar region.",
                                         True, (0, 0, 0))
        self.end_textLine3 = font.render("Congratulations on your achievement!", True, (0, 0, 0))
